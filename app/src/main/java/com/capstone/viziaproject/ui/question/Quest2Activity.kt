...
import com.capstone.viziaproject.databinding.ActivityQuest2Binding
import java.util.Collections

class Quest2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("cekcekquest2", "Received Label: $label")
        Log.d("cekcekquest2", "Received Confidence: $confidence")
        ...
        binding.nextButton.setOnClickListener {
            ...
            val intent = Intent(this, Quest3Activity::class.java).apply {
                putIntegerArrayListExtra("answers", answers)
                putExtra("imageUri", imageUri.toString())
                putExtra("label", label)
                putExtra("confidence", confidence)
            }
            startActivityForResult(intent, REQUEST_CODE_QUEST3)
        }
        ...
        binding.backButton.setOnClickListener {
            ...
            finish() // Finish Quest2Activity and return to Quest1Activity
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_CODE_QUEST3 && resultCode == RESULT_OK) {
    ...
    companion object {
        const val REQUEST_CODE_QUEST3 = 2
    }
}
