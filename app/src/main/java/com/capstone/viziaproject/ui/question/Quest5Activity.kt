...
import com.capstone.viziaproject.databinding.ActivityQuest5Binding
import java.util.Collections

class Quest5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityQuest5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuest5Binding.inflate(layoutInflater)
        ...
        Log.d("cekcekquest5", "Received Label: $label")
        Log.d("cekcekquest5", "Received Confidence: $confidence")
        ...
        binding.nextButton.setOnClickListener {
            ...
            val intent = Intent(this, Quest6Activity::class.java).apply {
                putIntegerArrayListExtra("answers", answers)
                putExtra("imageUri", imageUri.toString())
                putExtra("label", label)
                putExtra("confidence", confidence)
            }
            startActivityForResult(intent, REQUEST_CODE_QUEST6)
        }
        ...
        binding.backButton.setOnClickListener {
            ...
            finish() // Finish Quest5Activity and return to Quest4Activity
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_CODE_QUEST6 && resultCode == RESULT_OK) {
    ...
    companion object {
        const val REQUEST_CODE_QUEST6 = 5
    }
}
